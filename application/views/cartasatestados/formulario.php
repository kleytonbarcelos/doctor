<?php
	$titulo_formulario = ( $this->router->fetch_method() == 'cadastrar' ) ? '<strong><i class="fa fa-plus-square"></i>&nbsp;Cadastro de Cartas e atestados</strong>' : '<strong><i class="glyphicon glyphicon-edit"></i>&nbsp;Editar Cartas e atestados</strong>';
?>
<?=form_open_multipart('cartasatestados/salvar', array('id'=>'formCartasatestados', 'role'=>'form'))?>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group form-group-sm">
				...
				<input type="text" class="form-control" id="txtNome" name="txtNome" autocomplete="off" spellcheck="false" dir="auto" data-field-db="<?=sha1('cartasatestados.nome')?>" placeholder="Nome" value="<?=set_value('txtNome', $dados->nome)?>">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group form-group-sm">
				...
				<textarea class="ckeditor-basic" rows="5" id="txtTexto" name="txtTexto" data-field-db="<?=sha1('cartasatestados.texto')?>"><?=set_value('txtTexto', $dados->texto)?></textarea>
				<small class="msg-erro text-danger"></small>
			</div>
		</div>
	</div>
